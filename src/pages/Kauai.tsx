      ...
      <div className="container mx-auto px-4 py-12 space-y-20">
        ...
        <section className="space-y-6">
          <div className="text-center">
            <h2 className="text-3xl font-bold text-palm-100">Explore Kauai</h2>
            <p className="mt-2 text-gray-600">Discover the Garden Isle's natural wonders</p>
          </div>
          <KauaiMap />
        </section>

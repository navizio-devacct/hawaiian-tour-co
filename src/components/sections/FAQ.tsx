...
import { HelpCircle, CalendarDays, MapPin, Users, RefreshCcw, Shield, Phone, ArrowRight } from "lucide-react";
  ...
  const faqs = [
    {
      ...
      answer: "Hawaii is beautiful year-round! For the driest weather, visit April-October. For whale watching, December-May is perfect. We offer tours in all seasons with weather-appropriate options.",
      category: "Planning"
    },
    {
      id: "booking",
      ...
      answer: "We recommend booking 2-4 weeks ahead, especially for popular experiences like volcano tours, helicopter rides, and luaus. Many tours sell out during peak seasons (December-March, June-August).",
      category: "Booking"
    },
    {
      id: "islands",
      ...
      answer: "Each island offers unique experiences! Oahu has Waikiki and Pearl Harbor, Maui features the Road to Hana, Big Island showcases active volcanoes, and Kauai offers pristine nature. Our experts can help you choose based on your interests.",
      category: "Islands"
    },
    {
      id: "families",
      ...
      answer: "Absolutely! Most tours welcome children with age-appropriate options. We clearly mark age restrictions and provide family-friendly alternatives. Kids especially love snorkeling, cultural experiences, and wildlife tours.",
      category: "Families"
    },
    {
      id: "cancellation",
      ...
      answer: "Most tours offer free cancellation 24-48 hours before departure. Weather-related cancellations are always fully refunded. Each tour operator sets their specific policy, which we'll clearly show during booking.",
      category: "Policies"
    },
    {
      id: "safety",
      ...
      answer: "All our partner operators are licensed, insured, and regularly inspected. Our guides are certified professionals with extensive local knowledge. We maintain the highest safety standards across all activities.",
      category: "Safety"
    }
  ];
          ...
          <div className="bg-gradient-to-r from-blue-50 via-teal-50 to-blue-50 rounded-3xl p-12 border border-blue-100">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <button className="inline-flex items-center bg-blue-600 hover:bg-blue-700 text-white px-8 py-4 rounded-xl font-semibold text-lg shadow-lg transform hover:scale-105 transition-all duration-300">

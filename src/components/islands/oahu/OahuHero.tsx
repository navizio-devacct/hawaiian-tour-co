        ...
        <div className="text-center max-w-7xl mx-auto w-full mt-16 sm:mt-20">
          ...
          >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6 mb-6">
                ...
                <Select value={selectedCategory} onValueChange={setSelectedCategory}>
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="Photography Tours">📸 Photography</SelectItem>
            ...
            <div className="grid grid-cols-3 gap-4 sm:gap-6 md:gap-8 max-w-lg mx-auto mb-6 sm:mb-8 px-4">
              ...
              <div className="text-center">
                <div className="text-xl sm:text-2xl md:text-3xl font-bold text-cyan-200">4.8★</div>
                <div className="text-xs sm:text-sm opacity-90">Average Rating</div>
              </div>
              <div className="text-center">
                <div className="text-xl sm:text-2xl md:text-3xl font-bold text-green-200">25K+</div>

  ...
  return (
    <div className="relative min-h-screen w-full overflow-hidden">
      ...
      <div className="relative min-h-screen flex flex-col items-center justify-center text-white px-4 py-20">
        <div
          className={`text-center transform transition-all duration-700 max-w-6xl mx-auto ${
            isLoaded ? "translate-y-0 opacity-100" : "translate-y-10 opacity-0"
          }`}
        >
          {/* Updated badge with volcano theme */}
          <span className="inline-flex items-center bg-gradient-to-r from-red-500/90 to-orange-500/90 text-white px-6 py-2 rounded-full text-sm mb-8 backdrop-blur-sm shadow-lg border border-red-400/30">
          ...
          <p className="text-lg md:text-xl lg:text-2xl mb-12 max-w-3xl mx-auto text-gray-100 leading-relaxed px-4">
          ...
          <div className="max-w-5xl mx-auto bg-white/95 backdrop-blur-xl rounded-2xl p-6 md:p-8 shadow-2xl mb-12 border border-white/20">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 md:gap-6 mb-6">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className="pl-10 h-12 md:h-14 border-gray-200 text-gray-800 rounded-xl focus:ring-2 focus:ring-red-300"
                />
              </div>
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className="pl-10 h-12 md:h-14 border-gray-200 text-gray-800 rounded-xl"
              ...
              <Select value={selectedGuests} onValueChange={setSelectedGuests}>
                <SelectTrigger className="h-12 md:h-14 border-gray-200 text-gray-800 rounded-xl">
            ...
            <Button 
              ...
              className="w-full md:w-auto bg-gradient-to-r from-red-500 to-orange-500 hover:from-red-600 hover:to-orange-600 text-white px-8 md:px-10 py-3 md:py-4 h-12 md:h-14 text-lg font-semibold rounded-xl shadow-lg transform hover:scale-105 transition-all duration-300"
            >
          ...
          <div className="grid grid-cols-3 gap-6 md:gap-8 max-w-lg mx-auto mb-8 px-4">
            <div className="text-center">
              <div className="text-2xl md:text-3xl font-bold text-orange-200">35+</div>
              <div className="text-xs md:text-sm opacity-90">Volcano & Adventure Tours</div>
            </div>
            <div className="text-center">
              <div className="text-2xl md:text-3xl font-bold text-yellow-200">4.8★</div>
              <div className="text-xs md:text-sm opacity-90">Expert-Led Experiences</div>
            </div>
            <div className="text-center">
              <div className="text-2xl md:text-3xl font-bold text-red-200">Active</div>
              <div className="text-xs md:text-sm opacity-90">Kilauea Erupting Now!</div>
            </div>
          </div>

          {/* Live Activity Alert */}
          <div className="mt-8 mb-8 inline-flex items-center bg-red-500/90 text-white px-4 md:px-6 py-3 rounded-full text-sm font-medium backdrop-blur-sm shadow-lg border border-red-400/30 animate-pulse mx-4">
